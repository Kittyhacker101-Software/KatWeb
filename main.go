...
const currentVersion = "v1.10.3-dev"
...
var (
	...
	logt  = flag.String("logType", "none", `Type of logging displayed to the console. Supported values are "none", "simple", "common", "commonvhost", "combined", and "combinedvhost".`)
