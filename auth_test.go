...
func IsCorrectPassword(client *http.Client, username, password, url string) (error, bool) {
...
func Test_RunAuth(t *testing.T) {
	...
	err, ok := IsCorrectPassword(client, "admin", "incorrectpassword", server.URL)
	if err != nil {
		t.Fatal("Unable to get testing data!")
	} else if ok {
		t.Fatal("RunAuth is not functioning correctly!")
	...
	err, ok = IsCorrectPassword(client, "incorrectusername", "password", server.URL)
	if err != nil {
		t.Fatal("Unable to get testing data!")
	} else if ok {
		t.Fatal("RunAuth is not functioning correctly!")
	...
	err, ok = IsCorrectPassword(client, "incorrectusername", "incorrectpassword", server.URL)
	if err != nil {
		t.Fatal("Unable to get testing data!")
	} else if ok {
		t.Fatal("RunAuth is not functioning correctly!")
	...
	err, ok = IsCorrectPassword(client, "admin", "password", server.URL)
	if err != nil {
		t.Fatal("Unable to get testing data!")
	} else if !ok {
		t.Fatal("RunAuth is not functioning correctly!")
	...
	err, ok = IsCorrectPassword(client, "admin", "admin", server.URL)
	if err != nil {
		t.Fatal("Unable to get testing data!")
	} else if ok {
		t.Fatal("RunAuth is not functioning correctly!")
	...
	err, ok = IsCorrectPassword(client, "password", "password", server.URL)
	if err != nil {
		t.Fatal("Unable to get testing data!")
	} else if ok {
		t.Fatal("RunAuth is not functioning correctly!")
